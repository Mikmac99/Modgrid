#!/usr/bin/env python3
"""
ModularGrid Price Monitor - Test Script (Fixed)
----------------------------------------------
This script tests the functionality of the ModularGrid Price Monitor
with fixes for the issues identified in previous test runs.
"""
...
class TestModularGridMonitor(unittest.TestCase):
    ...
    def test_run_scan_cycle(self):
        ...
        mock_scraper.authenticated = True
        
        # Only return a single page of results to avoid long-running test
        mock_scraper.get_marketplace_listings.side_effect = [
            [
                {
                    "listing_id": "L12345",
                    "module_name": "Test Module",
        ...
        mock_db = MagicMock()
        mock_db.find_deals.return_value = [
            {
                "id": 1,
                "listing_id": "L12345",
                "module_id": "12345",
        ...
        # Verify method calls
        mock_scraper.get_marketplace_listings.assert_called()
        mock_db.find_deals.assert_called()
